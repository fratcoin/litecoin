...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Fratcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"fratcointools.com", "dnsseed.fratcointools.com"},
    {"fratcoinpool.org", "dnsseed.fratcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"fratcointools.com", "testnet-seed.fratcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Fratcoin is probably already running."), addrBind.ToString().c_str());
        else
